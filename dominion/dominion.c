...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case ambassador:
      return ambassadorFunction(choice1, choice2, state, handPos);
    ...
    case sea_hag:
      return sea_hagFunction(currentPlayer, state, handPos);
...
int ambassadorFunction(int choice1, int choice2, struct gameState *state, int handPos)
{
  int i;
  int j;
  int currentPlayer = whoseTurn(state);
...
int sea_hagFunction(int currentPlayer, struct gameState *state, int handPos)
{
  int i;
      for (i = 0; i < state->numPlayers; i++){
	if (i == currentPlayer){
